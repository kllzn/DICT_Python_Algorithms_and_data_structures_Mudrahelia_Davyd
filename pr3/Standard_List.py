...
{"-" * 225}
add ram1: {s_list.add(ssd1)}
add ram2: {s_list.add(ssd2)}
add ram3: {s_list.add(ssd3)}
add ram4: {s_list.add(ssd4)}
add ram5: {s_list.add(ssd5, 1)}
find: {s_list.find(ssd2)}
{"-" * 225}
get_all:  {s_list.get_all()}
size: {s_list.size}
{"-" * 225}
remove ram5: {s_list.remove(ssd5)}
...
{"-" * 225}
insert ram6: {s_list.insert(ssd6, 1)}
get_all:  {s_list.get_all()}
size: {s_list.size}
{"-" * 225}""")
